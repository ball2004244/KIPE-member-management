...
class ConnectToMySQL():
    def __init__(self):
        ...
        self.host = config.get('kipevietnam', 'HOST')
        self.user = config.get('kipevietnam', 'USER')
        self.password = config.get('kipevietnam', 'PASSWORD')
        self.port = config.get('kipevietnam', 'PORT')
        self.database = config.get('kipevietnam', 'DATABASE')
